            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title">{{isset($category_single)?ucwords($category_single->category_name):'Category'}}</h3>
                     <div class="breadcrumb__list">
                        <span><a href="{{route('website')}}">Home</a></span>
                        <span>{{isset($category_single)?ucwords($category_single->category_name):'Category'}}</span>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <div class="tp-shop-widget-content">
                           <div class="tp-shop-widget-filter">
                              ...
                              <div class="tp-shop-widget-filter-info d-flex align-items-center justify-content-between"  >
                                 ...
                                 <button type="btn" class="btn btn-outline-primary btn-sm px-3 mt-2" onclick="priceFilter()">Filter</button>
                                 {{-- <button class="tp-shop-widget-filter-btn" type="button" onclick="priceFilter()" >Filter</button> --}}
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="tp-shop-widget-content">
                           <div class="tp-shop-widget-checkbox">
                              <ul class="filter-items filter-checkbox">
                                 ...
                                 <button type="btn" class="btn btn-outline-primary btn-sm px-3 mt-2" onclick="stockFilter()">Filter</button>
                        ...
                        <div class="tp-shop-widget-content">
                           <div class="tp-shop-widget-product">
                              <div class="tp-shop-widget-product-item d-flex align-items-center">
                                 <div class="tp-shop-widget-product-thumb">
                                    <a href="product-details.html">
                                       <img src="{{asset('frontend_assets/img/product/shop/sm/shop-sm-1.jpg')}}" alt="no pic">
                                    </a>
                                 </div>
                              ...
                              <div class="tp-shop-widget-product-item d-flex align-items-center">
                                 <div class="tp-shop-widget-product-thumb">
                                    <a href="product-details.html">
                                       <img src="{{asset('frontend_assets/img/product/shop/sm/shop-sm-2.jpg')}}" alt="no pic">
                                    </a>
                                 </div>
                                 <div class="tp-shop-widget-product-content">
                                    <div class="tp-shop-widget-product-rating-wrapper d-flex align-items-center">
                              ...
                              <div class="tp-shop-widget-product-item d-flex align-items-center">
                                 <div class="tp-shop-widget-product-thumb">
                                    <a href="product-details.html">
                                       <img src="{{asset('frontend_assets/img/product/shop/sm/shop-sm-3.jpg')}}" alt="no pic">
                                    </a>
                                 </div>
                                 <div class="tp-shop-widget-product-content">
                                    <div class="tp-shop-widget-product-rating-wrapper d-flex align-items-center">
                              ...
                              <div class="tp-shop-widget-product-item d-flex align-items-center">
                                 <div class="tp-shop-widget-product-thumb">
                                    <a href="product-details.html">
                                       <img src="{{asset('frontend_assets/img/product/shop/sm/shop-sm-4.jpg')}}" alt="no pic">
                                    </a>
                                 </div>
                                 <div class="tp-shop-widget-product-content">
                                    <div class="tp-shop-widget-product-rating-wrapper d-flex align-items-center">
                                    ...
                                    <div class="col-xl-12">
                                       ...
                                       <div class="tp-product-list-item d-md-flex">
                                          <div class="tp-product-list-thumb p-relative fix">
                                             <a href="#">
                                                <img src="{{asset('frontend_assets/img/product/list/product-list-1.jpg')}}" alt="no pic">
                                             </a>
                     ...
                     <nav>
                        <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                           <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                              <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-1.jpg')}}" alt="no pic">
                           </button>
                           <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                              <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-2.jpg')}}" alt="no pic">
                           </button>
                           <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                              <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-3.jpg')}}" alt="no pic">
                           </button>
                           <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                              <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-4.jpg')}}" alt="no pic">
                           </button>
                        </div>
                     </nav>
                     <div class="tab-content m-img" id="productDetailsNavContent">
                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-1.jpg')}}" alt="no pic">
                           </div>
                        </div>
                        <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-2.jpg')}}" alt="no pic">
                           </div>
                        </div>
                        <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-3.jpg')}}" alt="no pic">
                           </div>
                        </div>
                        <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-4.jpg')}}" alt="no pic">
                           </div>
                        </div>
                        </div>
                  </div>
...
<script type="text/javascript">
   ...
   // single category_slug
  var  category_slug = document.getElementById("category_slug").value;

   const filterProducts = (products) => {
      var product_item = '';
      let rating_views = '';
      products.forEach(filter_products=> {
         // console.log(filter_products);
         let product_element_category_route = "{{route('category.products', '')}}" + "/" + filter_products.category_slug;
         let product_element_product_route = "{{route('product.detail', '')}}" + "/" + filter_products.product_slug;
         // Product Rating Views
         if(parseInt(filter_products.fill_count_stars) == 0 && parseInt(filter_products.unfill_count_stars) == 0){
            ...
            rating_views =filter_products.fill_count_stars +filter_products.unfill_count_stars;
         }
                        ...
                        <div class="tp-product-item-2 mb-40">
                           ...
                           <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                              <a href="${product_element_product_route}">
                                 <img src="{{asset('upload/product/${filter_products.product_thumbnail}')}}" alt="no pic">
                              </a>
                                     <!-- Product_hidden fields -->
                              <span><span><span>
                                 <input type="hidden" name="${filter_products.product_slug}_c_slug" value="${filter_products.category_slug}">
                                 <input type="hidden" name="${filter_products.product_slug}_name" value="${filter_products.product_name}">
                                 <input type="hidden" name="${filter_products.product_slug}_price" value="${parseFloat(filter_products.product_price).toFixed(2)}">
                                 <input type="hidden" name="${filter_products.product_slug}_s_qty" value="${filter_products.stock_quantity}">
                                 <input type="hidden" name="${filter_products.product_slug}_pro_qty" value="">
                                 <input type="hidden" name="${filter_products.product_slug}_thumbnail" value="${filter_products.product_thumbnail}">
                                 <input type="hidden" name="${filter_products.product_slug}_pro_stock_status" value="$${filter_products.product_stock_status}">
                              ...
                              <div class="tp-product-action-2 tp-product-action-blackStyle">
                                 <div class="tp-product-action-item-2 d-flex flex-column">
                                    <button type="button" onclick="addProductBasket(${filter_products.product_slug})" class="tp-product-action-btn-2 tp-product-add-cart-btn">
                                   ...
                                   {{--<button type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                    ...
                                    <button type="button" onclick="addProductWishlist(${filter_products.product_slug})" class="tp-product-action-btn-2 tp-product-add-to-wishlist-btn">
                                       <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path fill-rule="evenodd" clip-rule="evenodd" d="M1.60355 7.98635C2.83622 11.8048 7.7062 14.8923 9.0004 15.6565C10.299 14.8844 15.2042 11.7628 16.3973 7.98985C17.1806 5.55102 16.4535 2.46177 13.5644 1.53473C12.1647 1.08741 10.532 1.35966 9.40484 2.22804C9.16921 2.40837 8.84214 2.41187 8.60476 2.23329C7.41078 1.33952 5.85105 1.07778 4.42936 1.53473C1.54465 2.4609 0.820172 5.55014 1.60355 7.98635ZM9.00138 17.0711C8.89236 17.0711 8.78421 17.0448 8.68574 16.9914C8.41055 16.8417 1.92808 13.2841 0.348132 8.3872C0.347252 8.3872 0.347252 8.38633 0.347252 8.38633C-0.644504 5.30321 0.459792 1.42874 4.02502 0.284605C5.69904 -0.254635 7.52342 -0.0174044 8.99874 0.909632C10.4283 0.00973263 12.3275 -0.238878 13.9681 0.284605C17.5368 1.43049 18.6446 5.30408 17.6538 8.38633C16.1248 13.2272 9.59485 16.8382 9.3179 16.9896C9.21943 17.0439 9.1104 17.0711 9.00138 17.0711Z" fill="currentColor"/>
                                          <path fill-rule="evenodd" clip-rule="evenodd" d="M14.203 6.67473C13.8627 6.67473 13.5743 6.41474 13.5462 6.07159C13.4882 5.35202 13.0046 4.7445 12.3162 4.52302C11.9689 4.41097 11.779 4.04068 11.8906 3.69666C12.0041 3.35175 12.3724 3.16442 12.7206 3.27297C13.919 3.65901 14.7586 4.71561 14.8615 5.96479C14.8905 6.32632 14.6206 6.64322 14.2575 6.6721C14.239 6.67385 14.2214 6.67473 14.203 6.67473Z" fill="currentColor"/>
                                       </svg>                                                                               
                           ...
                           <div class="tp-product-content-2 pt-15">
                              <div class="tp-product-tag-2">
                                 <a href="${product_element_category_route}">${filter_products.category_name}</a>
                              </div>
                              <h3 class="tp-product-title-2">
                                 <a href="${product_element_product_route}">${filter_products.product_name}</a>
                              </h3>
                              <div class="tp-product-rating-icon tp-product-rating-icon-2">
                               ${rating_views}
                              </div>
                                <div class="tp-product-rating-text">
                                 <span>(${filter_products.single_reviews_count} Review)</span>
                              </div>
                              <div class="tp-product-price-wrapper-2">
                                 <span class="tp-product-price-2 new-price">$${parseFloat(filter_products.product_price).toFixed(2)}</span>
                                 <span class="tp-product-price-2 old-price">$${parseFloat(filter_products.product_old_price).toFixed(2)}</span>
                              </div>
                           </div>
                        </div>
                     </div> `;
   ...
   $(document).on('click', '.pagination-btn', function () {
      ...
      if(filter_value_obj.price_filter_status == true && filter_value_obj.stock_filter_status == true && filter_value_obj.category_status == true){
         priceFilter(page);
      } else if( filter_value_obj.category_status == true && filter_value_obj.price_filter_status == true){
         priceFilter(page);
      }else if( filter_value_obj.category_status == true && filter_value_obj.stock_filter_status == true){
         stockFilter(page);
      }else{
         categoryFilter(category_slug,page);
      }
   ...
   const categoryFilter = (slug , page = 1) => {
      $.ajax({
         ...
         method : "POST",
         dataType : "json",
         data: {'page' : page ,'category_slug' : category_slug , '_token' : _token},
         success : function (response){
            ...
            if(res_products){
               ...
               // $(".category_filter_products").html('<h5 class="text-center">Empty Product</h5>');
            }
            }else{
   ...
   const priceFilter = (page = 1) => {
      ...
      $.ajax({
            ...
            method : "POST",
            dataType : "json",
            data: {'page' : page , 'category_slug' : category_slug ,'price_amount': filter_value_obj.filter_price_amount , 'stock_filter_status' : filter_value_obj.stock_filter_status, 'price_filter_status' : filter_value_obj.price_filter_status,'in_stock' : filter_value_obj.in_stock,'out_stock': filter_value_obj.out_stock , '_token' : _token},            success : function (response){
               if(response.statuscode == 200){
                  // price_filter_status = true;
                  ...
                  if(res_products){
                     $(".category_filter_products").html(res_products);
                     // console.log(response.filtering_data);
                  }else{
   ...
   const stockFilter = (page = 1) => {
      ...
      filter_value_obj  =  multipleFiltersValue();
         console.log(filter_value_obj);
      if(in_stock != null || out_stock != null){
         $.ajax({
            url : "{{route('stockfilter')}}",
            method : "POST",
            dataType : "json",
            data: {'page' : page , 'category_slug' :  category_slug ,'price_filter_status' : filter_value_obj.price_filter_status, 'price_amount': filter_value_obj.filter_price_amount ,'in_stock' :filter_value_obj.in_stock,'out_stock':filter_value_obj.out_stock , '_token' : _token},
            success : function (response){
               if(response.statuscode == 200){
