            ...
            <div class="col-xxl-12">
               <div class="breadcrumb__content p-relative z-index-1">
                  {{-- <h3 class="breadcrumb__title">
                     {{isset($category_single)?ucwords($category_single->category_name):'Category'}}</h3> --}}
                     ...
                     <div class="tp-shop-widget-content">
                        <div class="tp-shop-widget-filter">
                           ...
                           <div class="tp-shop-widget-filter-info d-flex align-items-center justify-content-between">
                              ...
                              <button type="btn" class="btn btn-outline-primary btn-sm px-3 mt-2"
                                 onclick="priceFilter()">Filter</button>
                        ...
                        <div class="tp-shop-widget-checkbox">
                           <ul class="filter-items filter-checkbox">
                              <li class="filter-item checkbox">
                                 <input id="in_stock" type="checkbox" name="product_stock_status" value="A">
                                 <label for="in_stock">In Stock</label>
                              </li>
                              <li class="filter-item checkbox">
                                 <input id="out_stock" type="checkbox" name="product_stock_status" value="I">
                                 <label for="out_stock">Out of Stock</label>
                                 <br>
                                 <span class="text-danger error stock_error"></span>

                              </li>
                              <button type="btn" class="btn btn-outline-primary btn-sm px-3 mt-2"
                                 onclick="stockFilter()">Filter</button>
                  ...
                  <div class="tp-shop-widget mb-50">
                     ...
                     <div class="tp-shop-widget-content">
                        <div class="tp-shop-widget-categories">
                           <ul>
                              {{-- <input type="hidden" id="category_slug" value="{{$category_single->category_slug}}">
                              --}}
                              <input type="hidden" id="category_slug" class="getcategory" value="">
                            
                              @foreach ($allcategories as $category_list)
                              <li><a style="cursor:pointer"  class="add_class"  value="{{$category_list->category_name}}"
                                    onclick="categoryFilter({{$category_list->category_slug}})">{{$category_list->category_name}}

                                    <?php $product = 0;  ?>
                                    @foreach($category_products as $category_products_list)

                                    @if($category_list->id == $category_products_list->category_id)
                                    <?php  $product = $product + 1; ?>
                                    @endif
                  ...
                  <div class="tp-shop-items-wrapper tp-shop-item-primary">
                     <div class="tab-content" id="productTabContent">
                        ...
                        <div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel"
                           ...
                           <div class="multiple-products-grid">

                              <div class="row infinite-container category_filter_products">
                        ...
                        <div class="tab-pane fade" id="list-tab-pane" role="tabpanel" aria-labelledby="list-tab"
                           tabindex="0">
                           <div class="tp-shop-list-wrapper tp-shop-item-primary mb-70 multiple-products-list">
                                 ...
                                 <div class="col-xl-12">
                                    ...
                                    <div class="tp-product-list-item d-md-flex">
                                       <div class="tp-product-list-thumb p-relative fix">
                                          <a href="#">
                                             <img src="{{asset('frontend_assets/img/product/list/product-list-1.jpg')}}"
                                                alt="no pic">
                                          </a>
                  ...
                  <nav>
                     <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                        <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1"
                           ...
                           <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-1.jpg')}}"
                              alt="no pic">
                        </button>
                        <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2"
                           ...
                           <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-2.jpg')}}"
                              alt="no pic">
                        </button>
                        <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3"
                           ...
                           <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-3.jpg')}}"
                              alt="no pic">
                        </button>
                        <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4"
                           ...
                           <img src="{{asset('frontend_assets/img/product/details/nav/product-details-nav-4.jpg')}}"
                              alt="no pic">
                        </button>
                     </div>
                  </nav>
                  <div class="tab-content m-img" id="productDetailsNavContent">
                     <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab"
                        ...
                        <div class="tp-product-details-nav-main-thumb">
                           <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-1.jpg')}}"
                              alt="no pic">
                        </div>
                     </div>
                     <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                        <div class="tp-product-details-nav-main-thumb">
                           <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-2.jpg')}}"
                              alt="no pic">
                        </div>
                     </div>
                     <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                        <div class="tp-product-details-nav-main-thumb">
                           <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-3.jpg')}}"
                              alt="no pic">
                        </div>
                     </div>
                     <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                        <div class="tp-product-details-nav-main-thumb">
                           <img src="{{asset('frontend_assets/img/product/details/main/product-details-main-4.jpg')}}"
                              alt="no pic">
                        </div>
                     </div>
                  </div>
...
<script type="text/javascript">
   ...
   var price_filter_status = false;
   var stock_filter_status = false;
   var category_status = false;

   const filterProducts = (products) => {
      var product_item = '';
      let rating_views = '';
         products.forEach(filter_products_list => {

         let product_element_category_route = "{{route('category.products', '')}}" + "/" +filter_products_list.category_slug;
         let product_element_product_route = "{{route('product.detail', '')}}" + "/" + filter_products_list.product_slug;
         // Product Rating Views
            if(parseInt(filter_products_list.fill_count_stars) == 0 && parseInt(filter_products_list.unfill_count_stars) == 0){
               rating_views =  `<span><i class="fa-light fa-star"></i></span>
               <span><i class="fa-light fa-star"></i></span>
               <span><i class="fa-light fa-star"></i></span>
               <span><i class="fa-light fa-star"></i></span>
               <span><i class="fa-light fa-star"></i></span>`;
            }else{
               rating_views = filter_products_list.fill_count_stars + filter_products_list.unfill_count_stars;
            }

            product_item = product_item + `<div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                        <div class="tp-product-item-2 mb-40">
                           
                           <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                              <a href="${product_element_product_route}">
                                 <img src="{{asset('upload/product/${filter_products_list.product_thumbnail}')}}" alt="no pic">
                              </a>

                                <!-- Product_hidden fields -->
                              <span><span><span>
                                 <input type="hidden" name="${filter_products_list.product_slug}_c_slug" value="${filter_products_list.category_slug}">
                                 <input type="hidden" name="${filter_products_list.product_slug}_name" value="${filter_products_list.product_name}">
                                 <input type="hidden" name="${filter_products_list.product_slug}_price" value="${parseFloat(filter_products_list.product_price).toFixed(2)}">
                                 <input type="hidden" name="${filter_products_list.product_slug}_s_qty" value="${filter_products_list.stock_quantity}">
                                 <input type="hidden" name="${filter_products_list.product_slug}_pro_qty" value="">
                                 <input type="hidden" name="${filter_products_list.product_slug}_pro_stock_status" value="$${filter_products_list.product_stock_status}">
                                 <input type="hidden" name="${filter_products_list.product_slug}_thumbnail" value="${filter_products_list.product_thumbnail}">
                              </span></span></span> 
                              ...
                              <div class="tp-product-action-2 tp-product-action-blackStyle">
                                 <div class="tp-product-action-item-2 d-flex flex-column">
                                    <button type="button" onclick="addProductBasket(${filter_products_list.product_slug})"  class="tp-product-action-btn-2 tp-product-add-cart-btn">
                                   ...
                                   {{--<button type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                    ...
                                    <button type="button" onclick="addProductWishlist(${filter_products_list.product_slug})" class="tp-product-action-btn-2 tp-product-add-to-wishlist-btn">
                           ...
                           <div class="tp-product-content-2 pt-15">
                              <div class="tp-product-tag-2">
                                 <a href="${product_element_category_route}">${filter_products_list.category_name}</a>
                              </div>
                              <h3 class="tp-product-title-2">
                                 <a href="${product_element_product_route}">${filter_products_list.product_name}</a>
                              </h3>
                              <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                   ${rating_views}
                              </div>
                                 <div class="tp-product-rating-text">
                                 <span>(${filter_products_list.single_reviews_count} Review)</span>
                              </div>
                              <div class="tp-product-price-wrapper-2">
                                 <span class="tp-product-price-2 new-price">$${parseFloat(filter_products_list.product_price).toFixed(2)}</span>
                                 <span class="tp-product-price-2 old-price">$${parseFloat(filter_products_list.product_old_price).toFixed(2)}</span>
                              </div>
                           </div>
                        </div>
                     </div> `;
   ...
   const  renderPagination = (pagination) =>{
      console.log(pagination);
             // change page url //
            newUrl = "{{url('products')}}/" + '?page=' + pagination.current_page;
            history.pushState({}, null, newUrl);
            let html = '';
            if(parseInt(pagination.last_page) > 1){

               if (pagination.current_page > 1) {
                  html += `<button class="pagination-btn" data-page="${parseInt(pagination.current_page) - parseInt(1)}">Previous</button>`;
               }
                  for (let i = 1; i <= pagination.last_page; i++) {
                     html += `<button class="pagination-btn ${pagination.current_page == i ? 'active' : ''}" data-page="${i}">${i}</button>`;
                  }

               if (pagination.current_page < pagination.last_page) {
                  html += `<button class="pagination-btn" data-page="${ parseInt(pagination.current_page) + parseInt(1)}">Next</button>`;
               }
            }
      ...
      $.ajax({
         ...
         success : function (response){
            if(response.statuscode == 200){
             // render filter Products function
            res_products  = filterProducts(response.products_filter);
             // pagination function
             renderPagination(response.pagination);
            if(res_products){
               $(".category_filter_products").html(res_products);
               
            }else{
               // $(".category_filter_products").html('<h5 class="text-center">Product Not Available</h5>');
            }
            }else{
   ...
   $(document).on('click', '.pagination-btn', function () {
      filter_value_obj  =  multipleFiltersValue();
      console.log(filter_value_obj);
         const page = $(this).data('page');
      // console.log(filter_value_obj.stock_filter_status);
      // Check Pagination Conditions
      if(filter_value_obj.price_filter_status == true && filter_value_obj.stock_filter_status == true && filter_value_obj.category_status == true){
         categoryFilter(filter_value_obj.category_slug,page);

      } else if(filter_value_obj.stock_filter_status == true && filter_value_obj.category_status == true){
         categoryFilter(filter_value_obj.category_slug,page);

      }else if(filter_value_obj.category_status == true){
         categoryFilter(filter_value_obj.category_slug,page);

      }else if(filter_value_obj.stock_filter_status == true){
         stockFilter(page);
      }else if(filter_value_obj.price_filter_status == true){
         priceFilter(page);
      }else{
         productFilter(page);
      }

      // if(filter_value_obj.category_status == true ){
      //    categoryFilter(filter_value_obj.category_slug,page);
      // }else if(filter_value_obj.stock_filter_status == true){
      //    stockFilter(page);
      // }else{
   ...
   const categoryFilter = (slug , page = 1) => {

         document.getElementById('category_slug').setAttribute("value",slug);
         var  data = document.getElementsByClassName("add_class");
         ...
         filter_value_obj  =  multipleFiltersValue();
            $.ajax({
               ...
               method : "POST",
               dataType : "json",
               data: {'page' : page ,'category_slug' : slug ,'price_filter_status' : filter_value_obj.price_filter_status,'stock_filter_status' :filter_value_obj.stock_filter_status,'price_amount' :filter_value_obj.filter_price_amount, 'in_stock' :filter_value_obj.in_stock,'out_stock':filter_value_obj.out_stock ,'_token' : _token},
               success : function (response){
                  if(response.statuscode == 200){
                     for (let index = 0; index < data.length; index++) {
                        
                        data[index].classList.remove("text-primary");
                        let  category_name = data[index].getAttribute("value");
                           if(response.category_name == category_name){
                              data[index].classList.add("text-primary");
   ...
   // Price Filter
   const priceFilter = (page = 1) => {
      price_filter_status = true;
      filter_value_obj  =  multipleFiltersValue();
      $.ajax({
         url : "{{route('pricefilter')}}",
         method : "POST",
         dataType : "json",
         data: { 'page' : page ,'category_slug' : filter_value_obj.category_slug , 'price_amount': filter_value_obj.filter_price_amount , 'price_filter_status' : filter_value_obj.price_filter_status, 'stock_filter_status' : filter_value_obj.stock_filter_status,'in_stock' : filter_value_obj.in_stock,'out_stock': filter_value_obj.out_stock , '_token' : _token},
         success : function (response){
            if(response.statuscode == 200){
                
               // console.log(response.filter_status);
               // price_filter_status = true;
               res_products  = filterProducts(response.filtering_data,response.filtering_data.category_slug);
               renderPagination(response.pagination);
               if(res_products){
                  $(".category_filter_products").html(res_products);
               }else{
   ...
   const stockFilter = (page = 1) => {

      filter_value_obj  =  multipleFiltersValue();

      if(filter_value_obj.in_stock != null || filter_value_obj.out_stock != null){
         $.ajax({
            url : "{{route('stockfilter')}}",
            method : "POST",
            dataType : "json",
            data: {'page' : page ,'category_slug' : filter_value_obj.category_slug , 'price_amount': filter_value_obj.filter_price_amount ,'price_filter_status': filter_value_obj.price_filter_status, 'in_stock' : filter_value_obj.in_stock,'out_stock': filter_value_obj.out_stock , '_token' : _token},
            success : function (response){
               console.log(response);
               if(response.statuscode == 200){
                  // console.log(response.product_stock_data);
                  stock_filter_status = true;
                  res_products  = filterProducts(response.product_stock_data,response.product_stock_data.category_slug);
                  renderPagination(response.pagination);
   ...
   //  Function return the filters products object 
   const multipleFiltersValue = () => {
      // price filter amount value 
      var price_amount = document.getElementById('amount').value;
      // get category slug
      var slug = document.getElementById('category_slug').getAttribute("value");

      if($("#in_stock").is(':checked') &&  $("#out_stock").is(':checked') ){
         var in_stock =  document.getElementById("in_stock").value;
         var out_stock = document.getElementById("out_stock").value;
      }else if( $("#in_stock").is(':checked')){
         var in_stock = document.getElementById("in_stock").value;
      }else if( $("#out_stock").is(':checked')){
         var out_stock = document.getElementById("out_stock").value;
      }else{
         ...
         return {
            ...
            'in_stock' : in_stock,
            'out_stock' : out_stock,
            'filter_price_amount' : price_amount,
            'price_filter_status' : price_filter_status,
