                  ...
                  <div class="row align-items-center">
                     <div class="col-xl-5 col-lg-6 col-md-6">
                        <div class="tp-slider-content p-relative z-index-1">
                           ...
                           <div class="tp-slider-btn"> 
                              <a href="{{route('products')}}" class="tp-btn tp-btn-2 tp-btn-white">Shop Now 
                     ...
                     <div class="col-xl-7 col-lg-6 col-md-6">
                        <div class="tp-slider-thumb text-end">
                           <img src="{{asset('frontend_assets/img/slider/slider')}}-img-1.png" alt="slider-img">
                     ...
                     <div class="col">
                        <div class="tp-product-category-item text-center mb-40">
                           <div class="tp-product-category-thumb fix">
                              <a href="{{route("category.products", $category_item->category_slug)}}">
                                 <img src="{{asset('upload/category/'.$category_item->category_image)}}" alt="No Category image">
                              </a>
                           </div>
                           <div class="tp-product-category-content">
                              <h3 class="tp-product-category-title">
                                 <a href="{{route("category.products", $category_item->category_slug)}}">{{$category_item->category_name}}</a>
                              </h3>
                           </div>
                        </div>
                     </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
               <div class="tp-feature-item d-flex align-items-start">
                  ...
                  <div class="tp-feature-content">
                     <h3 class="tp-feature-title">Delivary</h3>
                     <p>Quickly Delivered Products</p>
                  </div>
               </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
               <div class="tp-feature-item d-flex align-items-start">
                  ...
                  <div class="tp-feature-content">
                     <h3 class="tp-feature-title">Handsome Price</h3>
                     <p>Reasonable Products Price</p>
                  </div>
               </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
               <div class="tp-feature-item d-flex align-items-start">
                  ...
                  <div class="tp-feature-content">
                     <h3 class="tp-feature-title">Product Quality</h3>
                  ...
                  <ul class="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="new-tab" data-bs-toggle="tab" data-bs-target="#new-tab-pane"
                           type="button" role="tab" aria-controls="new-tab-pane" aria-selected="true"
                           onclick="LoadNewarrivalsProducts(8)"> New
                     ...
                     <li class="nav-item" role="presentation">
                        <button class="nav-link" id="featured-tab" data-bs-toggle="tab"
                           ...
                           aria-controls="featured-tab-pane" aria-selected="false" onclick="LoadFeaturesProducts(8)">
                           Featured
                           <span class="tp-product-tab-line">
                              <svg width="52" height="13" viewBox="0 0 52 13" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                     ...
                     <li class="nav-item" role="presentation">
                        <button class="nav-link" id="topsell-tab" data-bs-toggle="tab"
                           data-bs-target="#topsell-tab-pane" type="button" role="tab" aria-controls="topsell-tab-pane"
                           aria-selected="false" onclick="LoadTopSellersProducts(8)"> Top Sellers
                           <span class="tp-product-tab-line">
                              <svg width="52" height="13" viewBox="0 0 52 13" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path d="M1 8.97127C11.6061 -5.48521 33 3.99996 51 11.4635" stroke="currentColor"
               ...
               <div class="tp-product-tab-content">
                  <div class="tab-content" id="myTabContent">
                     ...
                     <div class="tab-pane fade show active" id="new-tab-pane" role="tabpanel" aria-labelledby="new-tab"
                        tabindex="0">
                        <div class="row" id="new-arrivals-products">
                     ...
                     <div class="tab-pane fade" id="featured-tab-pane" role="tabpanel" aria-labelledby="featured-tab"
                        tabindex="0">
                        <div class="row" id="features-products">
                     ...
                     <div class="tab-pane fade" id="topsell-tab-pane" role="tabpanel" aria-labelledby="topsell-tab"
                        tabindex="0">
                        <div class="row" id="topsellers-products">

                        </div>
                     </div>
                        {{-- Load product Button --}}
                        <div class="text-center">
                           <button class="btn btn-primary"> <a href="{{route('products')}}">Load More</a></button>
                        </div>
                  </div>
               </div>
            </div>
               ...
               <div class="tp-product-gadget-sidebar mb-40">
                  <div class="tp-product-gadget-categories p-relative fix mb-10">
                     <div class="tp-product-gadget-thumb">
                        <img src="{{asset('frontend_assets/img/product/gadget/gadget-girl.png')}}" alt="">
                     </div>
...
<button type="button" onclick="addProductBasket('{{$Gadgets_category_products_item->product_slug}}')" class="tp-product-action-btn tp-product-add-cart-btn">                                             <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                           ...
                           <div class="tp-product-banner-thumb-wrapper p-relative">
                              <div class="tp-product-banner-thumb-shape">
                                 ...
                                 <img class="tp-offer-shape"
                                    src="{{asset('frontend_assets/img/banner/banner-slider-offer.png')}}" alt="">
                              </div>

                              <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                 <img src="{{asset('frontend_assets/img/banner/banner-slider-1.png')}}" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-6">
                           <div class="tp-product-banner-thumb-wrapper p-relative">
                              ...
                              <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                 <img src="{{asset('frontend_assets/img/banner/banner-slider-2.png')}}" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-6">
                           <div class="tp-product-banner-thumb-wrapper p-relative">
                              ...
                              <div class="tp-product-banner-thumb text-end p-relative z-index-1">
                                 <img src="{{asset('frontend_assets/img/banner/banner-slider-3.png')}}" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
   ...
   <section class="tp-product-sm-area">
      <div class="container">
         <div class="row">
             {{-- Latest New Products Section start--}}

            <div class="col-xl-4 col-md-6">
               <div class="tp-product-sm-list mb-50">
                  <div class="tp-section-title-wrapper mb-40">
                     <h3 class="tp-section-title tp-section-title-sm">New Products
                        <svg width="64" height="20" viewBox="0 0 64 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M62 13.1107C1.91792 -5.41202 -3.10865 1.22305 5.00242 18.3636" stroke="currentColor"
                              stroke-width="3" stroke-miterlimit="3.8637" stroke-linecap="round" />
                        </svg>
                     </h3>
                  </div>
                  ...
                  <div class="tp-product-sm-wrapper mr-20">
                     @if (isset($latest_newarrivals_products))
                     
                     @foreach ($latest_newarrivals_products as $latest_newarrivals_products_list )
         ...
         {{-- Latest New Products Section End--}}

         {{-- Latest Featured Products Section start--}}
            ...
            <div class="col-xl-4 col-md-6">
               <div class="tp-product-sm-list mb-50">
                  ...
                  <div class="tp-product-sm-wrapper mr-20">
                     ...
                     @if (isset($latest_features_products))
                     
                     @foreach ($latest_features_products as $latest_features_products_list )
         ...
         {{-- Latest Featured Products Section End--}}


          {{-- Latest Top Sellers Products Section --}}
             ...
             <div class="col-xl-4 col-md-6">
               <div class="tp-product-sm-list mb-50">
                  ...
                  <div class="tp-product-sm-wrapper mr-20">
                     ...
                     @if (isset($latest_topsellers_products))
                     
                     @foreach ($latest_topsellers_products as $latest_topsellers_products_list )
          ...
          {{--Latest Top Sellers Products Section End --}}
            ...
            <div class="col-xl-8 col-md-6">
               <div class="tp-blog-more-wrapper d-flex justify-content-md-end">
                  <div class="tp-blog-more mb-50 text-md-end">
                     <a href="{{route('show-blog')}}" class="tp-btn tp-btn-2 tp-btn-blue">View All Blog
            ...
            <div class="col-xl-12">
               ...
               <div class="tp-blog-main-slider">
                  ...
                  <div class="tp-blog-main-slider-active swiper-container">
                     ...
                     <div class="swiper-wrapper">
                         @foreach ($latest_blog as $latest_blog_list )

                        <div class="tp-blog-item mb-30 swiper-slide">

                           <div class="tp-blog-thumb p-relative fix">
                              <a href="{{route('show-blog')}}">
                                 <img src="{{asset('upload/Blog/'.$latest_blog_list->thumbnail)}}" alt="">
                              </a>
                              <div class="tp-blog-meta tp-blog-meta-date">
                                 <span> {{ $latest_blog_list->created_at->diffForHumans()}}</span>
                              </div>
                           </div>
                           <div class="tp-blog-content">
                              <h3 class="tp-blog-title">
                                 <a href="blog-details.html">
                                    ...
                                    @php  $length = strlen($latest_blog_list->title); @endphp

                                       {{
                                        ($length >= 100) ?  substr($latest_blog_list->title , 0 , 100).'....' 
                                        : substr($latest_blog_list->title, 0 , 20)
                                        }}
                              ...
                              {{
                                 ($length >= 100) ?  substr($latest_blog_list->description , 0 , 100).'....' 
                                 : substr($latest_blog_list->description, 0 , 100)
                              }} 

                              </p>

                              <div class="tp-blog-btn">
                                 <a href="{{route('show-blog')}}" class="tp-btn-2 tp-btn-border-2">
                                    Read More
                                    <span>
               ...
               {{--Latest New and Blog Section  End --}}
   ...
   <section class="tp-subscribe-area pt-70 pb-65 theme-bg p-relative z-index-1">
      <div class="tp-subscribe-shape">
         <img class="tp-subscribe-shape-1" src="{{asset('frontend_assets/img/subscribe/subscribe-shape-1.png')}}"
            alt="">
         <img class="tp-subscribe-shape-2" src="{{asset('frontend_assets/img/subscribe/subscribe-shape-2.png')}}"
            alt="">
         <img class="tp-subscribe-shape-3" src="{{asset('frontend_assets/img/subscribe/subscribe-shape-3.png')}}"
            alt="">
         <img class="tp-subscribe-shape-4" src="{{asset('frontend_assets/img/subscribe/subscribe-shape-4.png')}}"
            alt="">
         <!-- plane shape -->
         <div class="tp-subscribe-plane">
            <img class="tp-subscribe-plane-shape" src="{{asset('frontend_assets/img/subscribe/plane.png')}}" alt="">
...
<script type="text/javascript">
   ...
   const LoadNewarrivalsProducts = async (products_count) => {
      await $.ajax({
         url: '{{route('newarrivals.products', '')}}/' + products_count,
         type: "GET",
         beforeSend: function () {
            // show loader //
            // $("#new-arrivals-products").html('loading');
         },
         success: function (response) {

            if (response.statuscode == 200) {
               console.log(response);
               let render_products_sting = RenderProducts(response.newarrivalsproducts, 'new');
               $("#new-arrivals-products").html(render_products_sting);
            } else {
         ...
         error: function () {
            console.log('error in request LoadNewarrivalsProducts');
         }
      });
   }
   LoadNewarrivalsProducts(8);


   // LoadFeaturesProducts();
   const LoadFeaturesProducts = async (products_count) => {
      await $.ajax({
         url: '{{route('features.products', '')}}/' + products_count,
         type: "GET",
         beforeSend: function () {
            // show loader //
         },
         success: function (response) {
            ...
            if (response.statuscode == 200) {
               let render_products_sting = RenderProducts(response.featuresproducts, 'hot');
               $("#features-products").html(render_products_sting);
            } else {
               console.log(response.message);
            }
         },
         ...
         error: function () {
            console.log('error in request LoadFeaturesProducts');
         }
      });
   }
   ...
   const LoadTopSellersProducts = async (products_count) => {
      await $.ajax({
         url: '{{route('topsellers.products', '')}}/' + products_count,
         type: "GET",
         beforeSend: function () {
            // show loader //
         },
         success: function (response) {
            ...
            if (response.statuscode == 200) {
               let render_products_sting = RenderProducts(response.topsellersproducts, 'trending');
               $("#topsellers-products").html(render_products_sting);
            } else {
               console.log(response.message);
            }
         },
         ...
         error: function () {
            console.log('error in request LoadTopSellersProducts');
         }
      });
   }

   // render trending products  //
   const RenderProducts = (fetchproducts, badge_label) => {
      let send_products_string = ''; 
      let rating_views = '';
      fetchproducts.forEach(product_element => {
         let product_element_category_route = "{{route('category.products', '')}}" + "/" + product_element.category_slug;
         let product_element_product_route = "{{route('product.detail', '')}}" + "/" + product_element.product_slug;

         let product_badge_element = '';
         if (badge_label == 'new') {   
            product_badge_element = '<span class="product-sale">New</span>';

         } else if (badge_label == 'hot') {
            product_badge_element = '<span class="product-hot">Hot</span>';

         } else if (badge_label == 'trending') {
            product_badge_element = '<span class="product-trending">Trending</span>';
         }

         // Product Rating Views
         if(parseInt(product_element.fill_count_stars) == 0 && parseInt(product_element.unfill_count_stars) == 0){
            ...
            rating_views = product_element.fill_count_stars + product_element.unfill_count_stars;
         }



         send_products_string = send_products_string + `<div class="col-xl-3 col-lg-3 col-sm-6">
               <div class="tp-product-item p-relative transition-3 mb-25">
                  <div class="tp-product-thumb p-relative fix m-img thumb-max-height">
                     ...
                     <!-- product badge -->
                     <div class="tp-product-badge">
                        ${product_badge_element}
                     </div>
                     <!-- product action -->
                     <div class="tp-product-action">
                        <div class="tp-product-action-item d-flex flex-column">
      
                           <button type="button" onclick="addProductBasket(${product_element.product_slug})" class="tp-product-action-btn tp-product-add-cart-btn">
                           ...
                           <button type="button" onclick="addProductWishlist(${product_element.product_slug})"
          ...
          <span><span><span>
            ...
            <input type="hidden" name="${product_element.product_slug}_pro_stock_status" value="${product_element.product_stock_status}">
            ...
            <!-- Product_hidden fields End -->
                  ...
                  <div class="tp-product-content">
                     <div class="tp-product-category">
                        <a href="${product_element_category_route}">${product_element.category_name}</a>
                     </div>
                     <h3 class="tp-product-title title-min-height">
                        <a href="${product_element_product_route}">
                           ${trimStringHelper(product_element.product_name, 50)}
                        </a>
                     </h3>
                     <div class="tp-product-rating d-flex align-items-center">
                        <div class="tp-product-rating-icon">
                        ...
                        <div class="tp-product-rating-text">
                           <span>(${product_element.single_reviews_count} Review)</span>
                        </div>
                     </div>
                     <div class="tp-product-price-wrapper">
                        <span class="tp-product-price old-price">$${parseFloat(product_element.product_old_price).toFixed(2)}</span>
                        <span class="tp-product-price new-price">$${parseFloat(product_element.product_price).toFixed(2)}</span>
                     </div>
                  </div>
               </div>
            </div>`;
      ...
      return send_products_string;
   }
   var  localstorage_status = true;
   // Remove Localstroge Data
   ...
   // Order Status Check
    const  customerOrderStatus = () => {
         ...
         var session_id = "{{session()->get('payment_id')}}";
