               ...
               <div class="col-xl-6 col-lg-8">
                  <div class="tp-login-wrapper">
                     <div class="tp-login-top text-center mb-30">
                        <h3 class="tp-login-title">Login to {{isset($generalsetting->shop_name)?$generalsetting->shop_name:'Shop'}}.</h3>
                     </div>
                     <div class="tp-login-option">
                           ...
                           <div class="tp-login-input-wrapper">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="email" type="email" name="email" autocomplete="off" value="{{old('email')}}" placeholder="Type email" required>
                                 </div>
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="tp_password" type="password" name="password" autocomplete="off" placeholder="Min. 6 character" required>
                                 </div>
                        ...
                        <div class="mt-2">
                           <p>Don’t have an account? <span> <a href="{{route('customer.register')}}" class="text-primary">Create Account</a></span></p>
                        </div>
                     </div>
                  </div>
               </div>
