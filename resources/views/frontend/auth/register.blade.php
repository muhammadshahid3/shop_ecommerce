...
@section('content')
   ...
   <main>
      ...
      <section class="breadcrumb__area include-bg text-center pt-90">
         <div class="container">
            <div class="row">
      ...
      <section class="tp-login-area pb-140 p-relative z-index-1 fix">
         <div class="tp-login-shape">
            <img class="tp-login-shape-1" src="{{asset('frontend_assets/img/login/login-shape-1.png')}}" alt="no pic">
            <img class="tp-login-shape-2" src="{{asset('frontend_assets/img/login/login-shape-2.png')}}" alt="no pic">
            <img class="tp-login-shape-3" src="{{asset('frontend_assets/img/login/login-shape-3.png')}}" alt="no pic">
            <img class="tp-login-shape-4" src="{{asset('frontend_assets/img/login/login-shape-4.png')}}" alt="no pic">
         </div>
         <div class="container">
               ...
               <div class="col-xl-6 col-lg-8">
                  <div class="tp-login-wrapper">
                     <div class="tp-login-top text-center mb-30">
                        <h3 class="tp-login-title">Sign Up {{isset($generalsetting->shop_name)?$generalsetting->shop_name:'Shop'}}.</h3>
                     </div>
                     <div class="tp-login-option">
                           ...
                           <div class="tp-login-input-wrapper">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="name" type="text" autocomplete="off" name="username" placeholder="Your name" value="{{old('username')}}" required>
                                 </div>
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="email" type="email" autocomplete="off" name="email" placeholder="Type email" value="{{old('email')}}" required>
                                 </div>
                                 <div class="tp-login-input-title">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="phone_number" type="text" autocomplete="off" name="phone_number" placeholder="Min. 11 numbers" value="{{old('phone_number')}}" required>
                                 </div>
                                 <div class="tp-login-input-title">
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="tp_password" type="password" autocomplete="off" name="password" placeholder="Min. 6 character" required>
                                 </div>
                        ...
                        <div class="mt-2">
                           <p>Already have an account? <span> <a href="{{route('customer.login')}}" class="text-primary">Sign In</a></span></p>
                        </div>
                     </div>
                  </div>
               </div>
