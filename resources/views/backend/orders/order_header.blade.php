...
<head>
    ...
    {{-- Editor Css Link --}}
    <!-- <link rel="stylesheet" href="{{asset('backend_assets/Editor/editor.css')}}"> -->
    <!-- <link rel="stylesheet" href="{{asset('backend_assets/Editor/summernote-bs4.min.css')}}"> -->
    ...
    <!-- Datatable Styling internal css --> 
        <style>
        tbody, td, tfoot, th, thead, tr{
            ...
            table { border-collapse: collapse; empty-cells: show; }
                ...
                tr.strikeout td:before {
                    content: " "; position: absolute;top: 50%;left: 0; border-bottom: 1px solid #ccc; width: 100%;
                }
    ...
    <!-- Datatable Styling internal css  End-->
